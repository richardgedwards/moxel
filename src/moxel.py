...
class Moxel:
    ...
    def __repr__(self):
        ...
        repr = "Mesh Voxelization (Moxel) Characteristics:\n"
    ...
    def i2g(self, p):
        ...
        return self.R.apply(self.sla.d/self.q*(np.asarray(p)+0.5))+self.t
    ...
    def eval(self):
        ...
        with h5py.File(self.outfilename, 'w') as f:
            ...
            bbcyl = np.asarray([self.evalCylinderBB(pa=self.g2l(vtx[e[0]]), pb=self.g2l(vtx[e[1]]), r=self.radius) for e in edges])
            ii = 0
...
if __name__ == "__main__":
    ...
    mxl = Moxel('./msh/wedge.msh', radius=250e-6, R=None)
